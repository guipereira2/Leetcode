...
|---| ----- | -------- | ---------- | --------------------------| ------------------------------- |
|1|[Two Sum](https://leetcode.com/problems/two-sum/) | [Python](./array_e_hash/1_TwoSum.ipynb) [Goalang](./golang/TwoSum.go) | $${\color{green}\text{Fácil}}$$ | Array | 2 | 
...
|1302|[Deepest Leaves Sum](https://leetcode.com/problems/deepest-leaves-sum/) | [Python](./arvore/1302_Deepest_Leaves_Sum.ipynb) | $${\color{yellow}\text{Médio}}$$ | Árvore | 1 |
|2620|[Counter](https://leetcode.com/problems/counter/) | [TypeScript](./typescript%20/2620_Counter.ipynb) | $${\color{green}\text{Fácil}}$$ | Array | 1 |
|2620|[Compute Alternating Sum](https://leetcode.com/problems/compute-alternating-sum/) | [Python](./array_e_hash/3701_ComputeAlternatingSum.ipynb) | $${\color{green}\text{Fácil}}$$ | Array | 1 |